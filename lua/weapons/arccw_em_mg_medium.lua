...
SWEP.Animations = {
	...
	["reload"] = {
		...
		MinProgress = 3,
		SoundTable = {
			{ s = "weapons/p90/p90_clipout.wav", t = 0.0, p = 80 },
			{ s = "weapons/p90/p90_cliprelease.wav", t = 0.8, p = 80 },
			{ s = "weapons/p90/p90_clipin.wav", t = 1.9, p = 80 },
			{ s = "weapons/p90/p90_boltpull.wav", t = 3, p = 60 },
		}
	},
}
